<div class="list-group">
    ...
    <a href="#" class="list-group-item list-group-item-action"> Управління відгуками та пропозиціями </a>
    <a href="#" class="list-group-item list-group-item-action"> Управління знижками </a>
    <a href="#" class="list-group-item list-group-item-action"> Управління рекламою </a>
    <a href="#" class="list-group-item list-group-item-action"> Статистика сайту </a>
</div>